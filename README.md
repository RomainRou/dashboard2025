...
Update 8 : suppresion des cartes mini graph en raison d'un probleme avec card mod , les infos qui se travais dans la carte se retrouve sur la carte du dashboard et dans la carte entity<br><br>
